"""
Django settings for dbaccess project.
...
SECRET_KEY = '8$@4%zb4hi*^i^i#=-5+x!9*85fqce5+a=9@i#or4i7#yai@(+'
...
WSGI_APPLICATION = 'dbaccess.wsgi.application'
